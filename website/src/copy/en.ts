...
export const en: Copy = {
  ...
  scene: {
    events: [
      { tone: 'mut', name: 'Text', detail: '"I\'ll rerun the failing test."' },
      { tone: '', name: 'FunctionCall', detail: 'Bash · npm test' },
      { tone: 'warn', name: 'permissionRequest', detail: 'leaves the sandbox' },
      { tone: 'ok', name: 'permissionDecision', detail: 'approved by you' },
      { tone: '', name: 'FunctionResponse', detail: 'exit 1 · pruned, kept' },
      { tone: 'dim', name: 'FunctionCall', detail: 'Edit · resume.ts' },
      { tone: 'dim ok', name: 'endInvocation', detail: 'Run completed' },
    ],
    highWater: 'highWater',
