...
describe('shared bundled skill catalog', () => {
  for (const previousHash of [
    'sha256:bf62abc274b5716470c5db7eae36b7efe514018ace429578cf343af62aac3eca',
    'sha256:54337de254fb052a7ddab752cbbdbf92c7f2e3c6bf003d340a739658037f3979',
  ])
    it(`preserves installed Computer History trust without trusting a modified body: ${previousHash.slice(-8)}`, () => {
