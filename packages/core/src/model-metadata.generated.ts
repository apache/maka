...
export const GENERATED_MODELS_DEV_DIRECTORY: Record<string, { name: string; api?: string }> = {
  '302ai': { name: '302.AI', api: 'https://api.302.ai/v1' },
  abacus: { name: 'Abacus', api: 'https://routellm.abacus.ai/v1' },
  'abliteration-ai': { name: 'abliteration.ai', api: 'https://api.abliteration.ai/v1' },
  'ai-router': { name: 'AI-ROUTER', api: 'https://api.ai-router.dev/v1' },
  aiand: { name: 'ai&', api: 'https://api.aiand.com/v1' },
  aihubmix: { name: 'AIHubMix' },
  'aki-io': { name: 'AKI.IO', api: 'https://aki.io/v1' },
  alibaba: { name: 'Alibaba', api: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1' },
  'alibaba-cn': {
    name: 'Alibaba (China)',
  ...
  ambient: { name: 'Ambient', api: 'https://api.ambient.xyz/v1' },
  anthropic: { name: 'Anthropic' },
  anyapi: { name: 'AnyAPI', api: 'https://api.anyapi.ai/v1' },
  'atomic-chat': { name: 'Atomic Chat', api: 'http://127.0.0.1:1337/v1' },
  auriko: { name: 'Auriko', api: 'https://api.auriko.ai/v1' },
  azure: { name: 'Azure' },
  'azure-cognitive-services': { name: 'Azure Cognitive Services' },
  bailing: { name: 'Bailing', api: 'https://api.tbox.cn/api/llm/v1/chat/completions' },
  baseten: { name: 'Baseten', api: 'https://inference.baseten.co/v1' },
  berget: { name: 'Berget.AI', api: 'https://api.berget.ai/v1' },
  blueclaw: { name: 'Blue Claw', api: 'https://openai.blueclaw.network/v1' },
  cerebras: { name: 'Cerebras' },
  chutes: { name: 'Chutes', api: 'https://llm.chutes.ai/v1' },
  clarifai: { name: 'Clarifai', api: 'https://api.clarifai.com/v2/ext/openai/v1' },
  claudinio: { name: 'Claudinio', api: 'https://api.claudin.io/v1' },
  'cline-pass': { name: 'ClinePass', api: 'https://api.cline.bot/api/v1' },
  'cloudferro-sherlock': {
  ...
  cohere: { name: 'Cohere' },
  cortecs: { name: 'Cortecs', api: 'https://api.cortecs.ai/v1' },
  crof: { name: 'CrofAI', api: 'https://crof.ai/v1' },
  crossmodel: { name: 'CrossModel', api: 'https://api.crossmodel.ai/v1' },
  daoxe: { name: 'DaoXE', api: 'https://daoxe.com/v1' },
  databricks: { name: 'Databricks', api: 'https://${DATABRICKS_HOST}/ai-gateway/mlflow/v1' },
  deepinfra: { name: 'Deep Infra' },
  deepseek: { name: 'DeepSeek', api: 'https://api.deepseek.com' },
  digitalocean: { name: 'DigitalOcean', api: 'https://inference.do-ai.run/v1' },
  dinference: { name: 'DInference', api: 'https://api.dinference.com/v1' },
  drun: { name: 'D.Run (China)', api: 'https://chat.d.run/v1' },
  ebcloud: { name: 'EBCloud', api: 'https://maas-api.ebcloud.com/v1' },
  empiriolabs: { name: 'EmpirioLabs AI', api: 'https://api.empiriolabs.ai/v1' },
  evroc: { name: 'evroc', api: 'https://models.think.evroc.com/v1' },
  fastrouter: { name: 'FastRouter', api: 'https://go.fastrouter.ai/api/v1' },
  'fireworks-ai': { name: 'Fireworks AI', api: 'https://api.fireworks.ai/inference/v1/' },
  freemodel: { name: 'FreeModel', api: 'https://cc.freemodel.dev/v1' },
  friendli: { name: 'Friendli', api: 'https://api.friendli.ai/serverless/v1' },
  frogbot: { name: 'FrogBot', api: 'https://app.frogbot.ai/api/v1' },
  'github-copilot': { name: 'GitHub Copilot', api: 'https://api.githubcopilot.com' },
  gitlab: { name: 'GitLab Duo' },
  gmicloud: { name: 'GMI Cloud', api: 'https://api.gmi-serving.com/v1' },
  google: { name: 'Google' },
  'google-vertex': { name: 'Vertex' },
  'google-vertex-anthropic': { name: 'Vertex (Anthropic)' },
  greenpt: { name: 'GreenPT', api: 'https://api.greenpt.ai/v1' },
  groq: { name: 'Groq' },
  helicone: { name: 'Helicone', api: 'https://ai-gateway.helicone.ai/v1' },
  hetzner: { name: 'Hetzner', api: 'https://inference.hetzner.com/api/v1' },
  'hpc-ai': { name: 'HPC-AI', api: 'https://api.hpc-ai.com/inference/v1' },
  huggingface: { name: 'Hugging Face', api: 'https://router.huggingface.co/v1' },
  hyper: { name: 'Charm Hyper', api: 'https://hyper.charm.land/v1' },
  iflowcn: { name: 'iFlow', api: 'https://apis.iflow.cn/v1' },
  impossibl: { name: 'Impossibl', api: 'https://api.impossibl.com/v1' },
  inception: { name: 'Inception', api: 'https://api.inceptionlabs.ai/v1/' },
  inceptron: { name: 'Inceptron', api: 'https://api.inceptron.io/v1' },
  inference: { name: 'Inference', api: 'https://inference.net/v1' },
  inferx: { name: 'InferX', api: 'https://model.inferx.net/endpoints/v1' },
  'io-net': { name: 'IO.NET', api: 'https://api.intelligence.io.solutions/api/v1' },
  jiekou: { name: 'Jiekou.AI', api: 'https://api.jiekou.ai/openai' },
  kenari: { name: 'Kenari', api: 'https://kenari.id/v1' },
  kilo: { name: 'Kilo Gateway', api: 'https://api.kilo.ai/api/gateway' },
  'kimi-for-coding': { name: 'Kimi For Coding', api: 'https://api.kimi.com/coding/v1' },
  'kuae-cloud-coding-plan': {
    name: 'KUAE Cloud Coding Plan',
    api: 'https://coding-plan-endpoint.kuaecloud.net/v1',
  },
  lilac: { name: 'Lilac', api: 'https://api.getlilac.com/v1' },
  llama: { name: 'Llama', api: 'https://api.llama.com/compat/v1/' },
  llmgateway: { name: 'LLM Gateway', api: 'https://api.llmgateway.io/v1' },
  llmtr: { name: 'LLMTR', api: 'https://llmtr.com/v1' },
  lmstudio: { name: 'LMStudio', api: 'http://127.0.0.1:1234/v1' },
  longcat: { name: 'LongCat', api: 'https://api.longcat.chat/openai' },
  lucidquery: { name: 'LucidQuery', api: 'https://api.lucidquery.com/v1' },
  lynkr: { name: 'Lynkr', api: 'http://127.0.0.1:8081/v1' },
  meganova: { name: 'Meganova', api: 'https://api.meganova.ai/v1' },
  'merge-gateway': { name: 'Merge Gateway' },
  meta: { name: 'Meta', api: 'https://api.meta.ai/v1' },
  minimax: { name: 'MiniMax (minimax.io)', api: 'https://api.minimax.io/anthropic/v1' },
  'minimax-cn': { name: 'MiniMax (minimaxi.com)', api: 'https://api.minimaxi.com/anthropic/v1' },
  ...
  mixlayer: { name: 'Mixlayer', api: 'https://models.mixlayer.ai/v1' },
  moark: { name: 'Moark', api: 'https://moark.com/v1' },
  modal: { name: 'Modal', api: 'https://inference.us-west.modal.direct/v1' },
  'model-oracle-ai': { name: 'Model Oracle AI', api: 'https://api.modeloracle.com/api/v1' },
  modelis: { name: 'Modelis', api: 'https://modelishub.com/v1' },
  modelscope: { name: 'ModelScope', api: 'https://api-inference.modelscope.cn/v1' },
  moonshotai: { name: 'Moonshot AI', api: 'https://api.moonshot.ai/v1' },
  'moonshotai-cn': { name: 'Moonshot AI (China)', api: 'https://api.moonshot.cn/v1' },
  morph: { name: 'Morph', api: 'https://api.morphllm.com/v1' },
  'nano-gpt': { name: 'NanoGPT', api: 'https://nano-gpt.com/api/v1' },
  nearai: { name: 'NEAR AI Cloud', api: 'https://cloud-api.near.ai/v1' },
  nebius: { name: 'Nebius Token Factory', api: 'https://api.tokenfactory.nebius.com/v1' },
  neon: { name: 'Neon', api: '${NEON_AI_GATEWAY_BASE_URL}/v1' },
  neuralwatt: { name: 'Neuralwatt', api: 'https://api.neuralwatt.com/v1' },
  nova: { name: 'Nova', api: 'https://api.nova.amazon.com/v1' },
  'novita-ai': { name: 'NovitaAI', api: 'https://api.novita.ai/openai' },
  nvidia: { name: 'Nvidia', api: 'https://integrate.api.nvidia.com/v1' },
  ofox: { name: 'Ofox', api: 'https://api.ofox.ai/v1' },
  'ollama-cloud': { name: 'Ollama Cloud', api: 'https://ollama.com/v1' },
  openai: { name: 'OpenAI' },
  ...
  orcarouter: { name: 'OrcaRouter', api: 'https://api.orcarouter.ai/v1' },
  ovhcloud: {
    name: 'OVHcloud AI Endpoints',
    api: 'https://oai.endpoints.kepler.ai.cloud.ovh.net/v1',
  },
  perplexity: { name: 'Perplexity' },
  'perplexity-agent': { name: 'Perplexity Agent', api: 'https://api.perplexity.ai/v1' },
  pioneer: { name: 'Pioneer', api: 'https://api.pioneer.ai/v1' },
  poe: { name: 'Poe', api: 'https://api.poe.com/v1' },
  poolside: { name: 'Poolside', api: 'https://inference.poolside.ai/v1' },
  'privatemode-ai': { name: 'Privatemode AI', api: 'http://localhost:8080/v1' },
  'qihang-ai': { name: 'QiHang', api: 'https://api.qhaigc.net/v1' },
  'qiniu-ai': { name: 'Qiniu', api: 'https://api.qnaigc.com/v1' },
  qvac: { name: 'QVAC' },
  'regolo-ai': { name: 'Regolo AI', api: 'https://api.regolo.ai/v1' },
  requesty: { name: 'Requesty', api: 'https://router.requesty.ai/v1' },
  'routing-run': { name: 'routing.run', api: 'https://api.routing.run/v1' },
  sakana: { name: 'Sakana AI', api: 'https://api.sakana.ai/v1' },
  'sap-ai-core': { name: 'SAP AI Core' },
  sarvam: { name: 'Sarvam AI', api: 'https://api.sarvam.ai/v1' },
  scaleway: { name: 'Scaleway', api: 'https://api.scaleway.ai/v1' },
  siliconflow: { name: 'SiliconFlow', api: 'https://api.siliconflow.com/v1' },
  'siliconflow-cn': { name: 'SiliconFlow (China)', api: 'https://api.siliconflow.cn/v1' },
  'snowflake-cortex': {
  ...
  stepfun: { name: 'StepFun (China)', api: 'https://api.stepfun.com/v1' },
  'stepfun-ai': { name: 'StepFun (Global)', api: 'https://api.stepfun.ai/v1' },
  'stepfun-ai-step-plan': {
    name: 'StepFun Step Plan (Global)',
    api: 'https://api.stepfun.ai/step_plan/v1',
  },
  ...
  subconscious: { name: 'Subconscious', api: 'https://api.subconscious.dev/v1' },
  submodel: { name: 'submodel', api: 'https://llm.submodel.ai/v1' },
  synthetic: { name: 'Synthetic', api: 'https://api.synthetic.new/openai/v1' },
  'tencent-coding-plan': {
    name: 'Tencent Coding Plan (China)',
    api: 'https://api.lkeap.cloud.tencent.com/coding/v3',
  },
  ...
  'tencent-tokenhub': { name: 'Tencent TokenHub', api: 'https://tokenhub.tencentmaas.com/v1' },
  tensorx: { name: 'TensorX', api: 'https://api.tensorx.ai/v1' },
  'the-grid-ai': { name: 'The Grid AI', api: 'https://api.thegrid.ai/v1' },
  thinkingmachines: {
    name: 'Thinking Machines',
    api: 'https://tinker.thinkingmachines.dev/services/tinker-prod/anthropic/api/v1',
  },
  tinfoil: { name: 'Tinfoil', api: 'https://inference.tinfoil.sh/v1' },
  togetherai: { name: 'Together AI' },
  trustedrouter: { name: 'TrustedRouter', api: 'https://api.trustedrouter.com/v1' },
  'umans-ai': { name: 'Umans AI', api: 'https://api.code.umans.ai/v1' },
  'umans-ai-coding-plan': { name: 'Umans AI Coding Plan', api: 'https://api.code.umans.ai/v1' },
  unorouter: { name: 'UnoRouter', api: 'https://api.unorouter.com/v1' },
  upstage: { name: 'Upstage', api: 'https://api.upstage.ai/v1/solar' },
  v0: { name: 'v0' },
  venice: { name: 'Venice AI' },
  vercel: { name: 'Vercel AI Gateway' },
  vivgrid: { name: 'Vivgrid', api: 'https://api.vivgrid.com/v1' },
  vultr: { name: 'Vultr', api: 'https://api.vultrinference.com/v1' },
  'wafer.ai': { name: 'Wafer', api: 'https://pass.wafer.ai/v1' },
  wandb: { name: 'Weights & Biases', api: 'https://api.inference.wandb.ai/v1' },
  xai: { name: 'xAI' },
  xiaomi: { name: 'Xiaomi', api: 'https://api.xiaomimimo.com/v1' },
  'xiaomi-token-plan-ams': {
    name: 'Xiaomi Token Plan (Europe)',
    api: 'https://token-plan-ams.xiaomimimo.com/v1',
  },
  ...
  xpersona: { name: 'Xpersona', api: 'https://www.xpersona.co/v1' },
  zai: { name: 'Z.AI', api: 'https://api.z.ai/api/paas/v4' },
  'zai-coding-plan': { name: 'Z.AI Coding Plan', api: 'https://api.z.ai/api/coding/paas/v4' },
  zeldoc: { name: 'Zeldoc', api: 'https://api.zeldoc.ai/v1' },
  zenifra: { name: 'Zenifra', api: 'https://ai.zenifra.com/v1' },
  zenmux: { name: 'ZenMux', api: 'https://zenmux.ai/api/v1' },
  zhipuai: { name: 'Zhipu AI', api: 'https://open.bigmodel.cn/api/paas/v4' },
  'zhipuai-coding-plan': {
