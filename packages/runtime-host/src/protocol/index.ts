...
// 144: Client capability publication gains Session scopes and explicit MCP admission.
// Older peers cannot enforce the corresponding Session isolation and grant contract.
