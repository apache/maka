...
// 167: Trae Connections carry an account variant on OAuth create targets and
// catalog headers, and live Turn snapshots carry the provider queue position.
// Older peers reject the added fields.
