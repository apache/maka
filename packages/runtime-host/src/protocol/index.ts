...
// 113: Client Capability schemas recursively validate draft-07 tuple
// `additionalItems` schemas before admission. Older peers may apply a
// different validation boundary to the same manifest.
