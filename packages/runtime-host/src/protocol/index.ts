...
// 156: Client Plugins gain generation-fenced Host Remote calls and pull streams.
// 155: Client Plugin bundles and the desktop-ui composition are projected
// through one strict, content-addressed Host query contract.
