...
// 134: Agent Graph operator snapshots carry bounded output previews and metrics.
// Epoch-133 peers reject the additional `output` field on strict operator shapes.
