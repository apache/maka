...
// 158: Agent Graph operator snapshots carry bounded output previews and metrics.
// Epoch-157 peers reject the additional `output` field on strict operator shapes.
