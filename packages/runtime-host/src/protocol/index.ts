...
export const RUNTIME_HOST_COMPATIBILITY_EPOCH = 54 as const;
// 54: Session mailbox target discovery and durable cross-Session delivery.
// Epoch-53 peers do not know these closed operation keys or trusted provenance.
