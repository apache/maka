...
// 37: connection.onboarding.verify accepts transient endpoint and request-header
// overrides. Older Hosts reject those fields, so mixed-version peers must be
// replaced during the handshake instead.
