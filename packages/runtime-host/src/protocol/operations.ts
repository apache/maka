...
export const REMOTE_OWNER_OPERATION_GRANTS = Object.freeze([
  ...
  'usage.query',
  'web-search.execute',
  'workhub.coordination.voice-maintain',
  'workhub.coordination.voiceState',
  'workhub.coordination.voiceDelivery',
  'workhub.coordination.voiceRequest',
  'workhub.coordination.voiceEnqueue',
  'workhub.coordination.voiceTranscript',
