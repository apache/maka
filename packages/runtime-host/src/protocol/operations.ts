...
const CORE_MESSAGE_TASK_LEDGER_INTERACTION_CONTINUITY_AND_SESSION_CATALOG_OPERATION_SPECS =
  composeOperationSpecMaps(
    CORE_MESSAGE_TASK_LEDGER_INTERACTION_AND_CONTINUITY_OPERATION_SPECS,
    SESSION_CATALOG_OPERATION_SPECS,
  );

const CORE_MESSAGE_TASK_LEDGER_INTERACTION_CONTINUITY_SESSION_CATALOG_AND_ARTIFACT_OPERATION_SPECS =
  composeOperationSpecMaps(
    CORE_MESSAGE_TASK_LEDGER_INTERACTION_CONTINUITY_AND_SESSION_CATALOG_OPERATION_SPECS,
    ARTIFACT_OPERATION_SPECS,
  );

const ALL_BUT_MEMORY_OPERATION_SPECS = composeOperationSpecMaps(
  CORE_MESSAGE_TASK_LEDGER_INTERACTION_CONTINUITY_SESSION_CATALOG_AND_ARTIFACT_OPERATION_SPECS,
