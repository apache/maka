...
// directories truncate the base64url root tag to 16 characters, directories
// from before #2133 used the full tag, and the endpoint root resolves to
// os.tmpdir() with a /tmp fallback. Unlike the production startup sweep this
// ignores liveness, because callers run it after their hosts have exited.
