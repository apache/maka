...
import { defineTuiCopyCatalog, getTuiCopyCatalog } from './tui-copy-catalog.js';
...
const TUI_PRIMARY_GUIDANCE = defineTuiCopyCatalog<TuiPrimaryGuidanceCopy>()(
  getTuiCopyCatalog('primary-guidance'),
);
