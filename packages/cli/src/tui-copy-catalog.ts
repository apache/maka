...
export const TUI_COPY_RESOURCES = {
  ...
  pickers: {
    en: {
      ...
      resumeUnavailableNotice: 'Safe-boundary resume is unavailable on this runtime.',
  ...
  'session-actions': {
    en: {
      ...
      externalSessionTitle: 'Import from {source}',
      externalLoadMore: 'Load more…',
      ...
      externalImportSourceUnreadable: 'The external session could not be read or converted.',
      externalImportLimit: 'The external session exceeds the supported {kind} limit ({max}).',
      externalImportLimitTranscriptBytes: 'source file size',
      externalImportLimitRecordBytes: 'single-record size',
      externalImportLimitRecords: 'record count',
    ...
    'zh-CN': {
      ...
      externalSessionTitle: '从 {source} 导入',
      externalLoadMore: '加载更多…',
      ...
      externalImportLimit: '外部会话超过支持的 {kind} 上限（{max}）。',
      externalImportLimitTranscriptBytes: '源文件大小',
      externalImportLimitRecordBytes: '单条记录大小',
    ...
    'zh-TW': {
      ...
      externalSessionTitle: '從 {source} 匯入',
      externalLoadMore: '載入更多…',
      ...
      externalImportLimit: '外部工作階段超過支援的 {kind} 上限（{max}）。',
      externalImportLimitTranscriptBytes: '來源檔案大小',
      externalImportLimitRecordBytes: '單筆記錄大小',
