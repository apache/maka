...
export const TUI_COPY_RESOURCES = {
  ...
  pickers: {
    en: {
      ...
      verifyFailed:
        '{hasDetail, select, true {API key verification failed: {detail}. Check it and try again.} other {API key verification failed. Check it and try again.}}',
    ...
    zh: {
      ...
      verifyFailed:
        '{hasDetail, select, true {API key 验证失败：{detail}。请检查后重新输入。} other {API key 验证失败，请检查后重新输入。}}',
      setupFailed: '配置失败：{detail}',
      saveFailed: '保存失败：{detail}',
      listProvidersFailed: '无法读取已配置的连接：{detail}',
