...
const RUNTIME_POLICY_TEMP_PATTERN =
  /^(?:runtime-policy|connection-catalog|credential-vault|runtime-policy-onboarding|model-facts)\.json\.[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}\.tmp$/;
