...
export interface ScheduledTaskCopy {
  ...
  /** The detail dialog: one selected task, its facts and its actions. */
  detail: {
    enabled: string;
    recurrence: string;
    nextRun: string;
