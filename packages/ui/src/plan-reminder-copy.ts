...
export interface PlanReminderCopy {
  ...
  form: {
    ...
    field: { title: string; time: string; timeInput: string; recurrence: string; delivery: string; platform: string; cron: string; chatId: string; note: string };
