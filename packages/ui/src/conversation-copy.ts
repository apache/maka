...
export interface ConversationCopy {
  ...
  sessions: {
    ...
    recent: string;
    /** Project-sort active project section title. */
    projects: string;
    groupByTime: string;
