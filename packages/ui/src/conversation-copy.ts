...
const CONVERSATION_COPY = {
  zh: {
    ...
    messages: {
      ...
      mailboxIncoming: '来自任务', mailboxOutgoing: '发送到任务', mailboxDelivered: '已送达 · 已开始处理', mailboxQueued: '已排队 · 将在下一轮处理', mailboxIncomingAriaLabel: (sessionName) => `来自任务“${sessionName}”的消息`, mailboxOutgoingAriaLabel: (sessionName) => `发送到任务“${sessionName}”的消息`,
  ...
  en: {
    ...
    messages: {
      ...
      mailboxIncoming: 'From task', mailboxOutgoing: 'Sent to task', mailboxDelivered: 'Delivered · processing started', mailboxQueued: 'Queued · will process next turn', mailboxIncomingAriaLabel: (sessionName) => `Message from task “${sessionName}”`, mailboxOutgoingAriaLabel: (sessionName) => `Message sent to task “${sessionName}”`,
