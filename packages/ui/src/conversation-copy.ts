...
const CONVERSATION_COPY = {
  zh: {
    ...
    sessions: {
      status: { active: '可继续', running: '进行中', waiting_for_user: '等你确认', blocked: '需要处理', archived: '已归档', aborted: '已中止' },
  ...
  en: {
    ...
    sessions: {
      status: { active: 'Ready', running: 'Running', waiting_for_user: 'Waiting for you', blocked: 'Needs attention', archived: 'Archived', aborted: 'Stopped' },
