...
| `apps/desktop/src/renderer/features/workbar/tools/review/session-review-base-branch-picker.tsx` | shell-chrome-or-panel | Selector, Text | aligned — uses Astryx (Selector, Text) | aligned |
