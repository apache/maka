...
| `apps/desktop/src/renderer/settings/provider-add-form.tsx` | settings-module | Banner, Button, Collapsible, HStack, Selector, Text, VStack | aligned — uses Astryx (Banner, Button, Collapsible, HStack, Selector, Text, VStack) | aligned |
