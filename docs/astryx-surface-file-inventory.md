...
| `apps/desktop/src/renderer/features/workbar/tools/terminal/terminal-handoff-panel.tsx` | shell-chrome-or-panel | Banner, Button, ChatComposer, CheckboxInput, TextInput | aligned — uses Astryx (Banner, Button, ChatComposer, CheckboxInput, TextInput) | aligned |
