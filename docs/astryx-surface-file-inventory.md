...
| `apps/desktop/src/renderer/features/workbar/tools/review/session-review-base-branch-picker.tsx` | shell-chrome-or-panel | Selector | aligned — uses Astryx (Selector) | aligned |
