...
| `apps/desktop/src/renderer/features/module-hub/ui/computer-history-document.tsx` | other | CodeBlock, Markdown, SegmentedControl, SegmentedControlItem | aligned — uses Astryx (CodeBlock, Markdown, SegmentedControl, SegmentedControlItem) | aligned |
