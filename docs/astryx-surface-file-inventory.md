...
| `packages/ui/src/session-history-list.tsx` | shell-chrome-or-panel | Badge, Button, MoreMenu, SideNavItem, StatusDot | aligned — uses Astryx (Badge, Button, MoreMenu, SideNavItem, StatusDot) | aligned |
