...
| `apps/desktop/src/renderer/features/module-hub/ui/mcp-page.tsx` | module-hub | Banner, Button, ClickableCard, Collapsible, Dialog, DialogHeader, Divider, EmptyState, Grid, HStack, Heading, IconButton, Layout, LayoutContent, List, ListItem, MetadataList, MetadataListItem, SegmentedControl, SegmentedControlItem, Selector, Skeleton, StackItem, StatusDot, Switch, Text, TextArea, TextInput, Toolbar, VStack | aligned — uses Astryx (Banner, Button, ClickableCard, Collapsible, Dialog, DialogHeader, Divider, EmptyState) | aligned |
