...
| `apps/desktop/src/renderer/features/connection-settings/model-context-target-boundary.tsx` | other | none | aligned — no raw controls; no Astryx JSX usage | aligned |
