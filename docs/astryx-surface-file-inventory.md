...
| `apps/desktop/src/renderer/features/module-hub/ui/mcp-page.tsx` | module-hub | Button, Collapsible, Dialog, DialogHeader, Divider, EmptyState, HStack, Heading, IconButton, Layout, LayoutContent, List, ListItem, MetadataList, MetadataListItem, SegmentedControl, SegmentedControlItem, Selector, Skeleton, StackItem, StatusDot, Switch, Text, TextArea, TextInput, Toolbar, VStack | aligned — uses Astryx (Button, Collapsible, Dialog, DialogHeader, Divider, EmptyState, HStack, Heading) | aligned |
...
| `packages/ui/src/model-picker-panel.tsx` | shell-chrome-or-panel | Button, TextInput | aligned — uses Astryx (Button, TextInput) | aligned |
...
| `packages/ui/src/scheduled-task-detail.tsx` | module-hub | Button, Divider, HStack, List, ListItem, MetadataList, MetadataListItem, StackItem, StatusDot, Switch, Text, VStack | aligned — uses Astryx (Button, Divider, HStack, List, ListItem, MetadataList, MetadataListItem, StackItem) | aligned |
