...
export const UsageInspector: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await userEvent.click(canvas.getByRole('button', { name: '在主窗口查看工作面板' }));
    await waitFor(() => expect(writes.panel).toHaveBeenCalledWith('workbar'));
  },
};
