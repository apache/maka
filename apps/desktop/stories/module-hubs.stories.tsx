...
import {
  ...
  createFakeHistoryDraftHostInput,
...
function ModuleHubHostSurface(props: {
  ...
  return (
    <ModuleSurface agentsView={agentsView}>
      <ModuleHubHostView model={model} onOpenSettings={noop} isObscured={false} />
    </ModuleSurface>
  );
}
    ...
    <ModuleSurface agentsView="skills">
      <ModuleHubServicesProvider services={services}>
        <ModuleHubProvider
          ...
          useSkillInChat={noop}
          openSession={noop}
          historyDraft={createFakeHistoryDraftHostInput()}
          appendComposerText={noop}
          captureActiveComposerClaim={() => undefined}
          commandPort={commandPort}
        >
          <ModuleHubHost onOpenSettings={noop} isObscured={false} />
        </ModuleHubProvider>
      </ModuleHubServicesProvider>
    </ModuleSurface>
  );
