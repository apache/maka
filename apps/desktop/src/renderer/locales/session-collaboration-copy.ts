...
const ZH = {
    ...
    directPathUnavailable: '未能连接到任务所在的 Runtime Host。请确认此设备与该 Runtime Host 加入了同一个 Peer Mesh，或使用其他可达的连接路径。',
...
const EN = {
    ...
    directPathUnavailable: 'Could not reach the Runtime Host for this task. Make sure this device and the Runtime Host have joined the same Peer Mesh, or use another reachable connection path.',
