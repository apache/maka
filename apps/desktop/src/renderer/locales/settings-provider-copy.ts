...
const zhCopy = {
  ...
  panel: {
    ...
    connectedLoading: '账号已连接，正在载入新的模型连接…', connectedLoadFailed: '账号已连接，但暂时无法载入新的模型连接。',
...
const enCopy: ProviderSettingsCopy = {
  ...
  panel: {
    ...
    connectedLoading: 'Account connected. Loading the new model connection…', connectedLoadFailed: 'Account connected, but the new model connection could not be loaded yet.',
