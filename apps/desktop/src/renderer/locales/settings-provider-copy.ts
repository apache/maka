...
const zhCopy = {
  detail: {
    ...
    savingDefaultModel: '保存默认模型中…', defaultModelSet: (model: string) => `默认模型已更新 · ${model}`,
    ...
    enabledModelsHelp: '勾选的模型会出现在模型选择器中。', searchDefaultModels: '搜索默认模型',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    savingDefaultModel: 'Saving default model…', defaultModelSet: (model: string) => `Default model updated · ${model}`,
    ...
    enabledModelsHelp: 'Selected models appear in the model picker.', searchDefaultModels: 'Search default models',
