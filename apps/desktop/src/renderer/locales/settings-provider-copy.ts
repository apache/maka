...
const zhCopy = {
  ...
  oauthSection: {
    ...
    codexDetail: '点击下方按钮打开设备授权页，并在页面中输入这里显示的登录码。', xaiDetail: '点击下方按钮打开 xAI 设备授权页，并核对页面中的登录码。', deviceCode: '登录码：', stateHint: '提示：state 以', startsWith: '开头。',
...
const enCopy: ProviderSettingsCopy = {
  ...
  oauthSection: {
    ...
    codexDetail: 'Open the device page below and enter the sign-in code shown here.', xaiDetail: 'Open the xAI device page below and verify the sign-in code shown there.', deviceCode: 'Sign-in code:', stateHint: 'Tip: state begins with', startsWith: '.',
