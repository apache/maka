...
const zhCopy = {
  ...
  oauthSection: {
    ...
    copilotSignIn: '登录 GitHub 账号', copilotDeviceWaiting: '等待授权…',
    copilotDevicePrompt: (url: string) => `在浏览器打开 ${url}，输入下面的验证码完成登录。`,
    copilotDeviceCancel: '取消登录',
...
const enCopy: ProviderSettingsCopy = {
  ...
  oauthSection: {
    ...
    copilotSignIn: 'Sign in with GitHub', copilotDeviceWaiting: 'Waiting for authorization…',
    copilotDevicePrompt: (url: string) => `Open ${url} in your browser and enter the code below.`,
    copilotDeviceCancel: 'Cancel sign-in',
