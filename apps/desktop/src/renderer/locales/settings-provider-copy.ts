...
const zhCopy = {
  detail: {
    ...
    profilePrimary: '主账号', profileSecondary: (label: string) => `备用账号 · ${label}`,
    ...
    profileRemove: '移除', profileRemovePrimaryHelp: '主账号是连接的身份，不能移除。',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    profilePrimary: 'Primary account', profileSecondary: (label: string) => `Secondary account · ${label}`,
    ...
    profileRemove: 'Remove', profileRemovePrimaryHelp: 'The primary account is the connection identity and cannot be removed.',
