...
const zhCopy = {
  detail: {
    ...
    enabledModelsHelp: '勾选的模型会出现在模型选择器中。', searchModels: '搜索模型', searchDefaultModels: '搜索默认模型', modelListAria: '模型列表',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    enabledModelsHelp: 'Selected models appear in the model picker.', searchModels: 'Search models', searchDefaultModels: 'Search default models', modelListAria: 'Model list',
