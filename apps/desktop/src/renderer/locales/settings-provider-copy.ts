...
const zhCopy = {
  ...
  panel: {
    ...
    defaultTarget: '默认模型', defaultTargetHelp: '新对话从这个连接的这个模型开始；每个对话仍可单独切换。',
    noDefault: '尚未选择', noEnabledModels: '还没有启用任何模型', switchDefaultFailed: '切换默认模型失败',
  },
  catalog: {
...
const enCopy: ProviderSettingsCopy = {
  ...
  panel: {
    ...
    defaultTarget: 'Default model', defaultTargetHelp: 'New chats start on this connection and this model; each chat can still switch.',
    noDefault: 'Not chosen yet', noEnabledModels: 'No models are enabled yet', switchDefaultFailed: 'Failed to change the default model',
  },
  catalog: {
