...
const zhCopy = {
  detail: {
    ...
    advancedHelp: '默认走服务商的地址；用代理或自建服务时改这里。',
    modelManagement: '模型', connectionDefaultModel: '默认模型',
  ...
  panel: {
    ...
    noDefault: '尚未选择', switchDefaultFailed: '切换默认连接失败',
  },
  catalog: {
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    modelManagement: 'Models', connectionDefaultModel: 'Default model',
  ...
  panel: {
    ...
    noDefault: 'Not chosen yet', switchDefaultFailed: 'Failed to change the default connection',
  },
  catalog: {
