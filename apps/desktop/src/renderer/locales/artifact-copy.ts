...
const ARTIFACT_COPY = {
  'zh-CN': {
    pane: {
      ...
      focusPreview: '聚焦文件', restorePreview: '还原分栏', moveComposer: '拖到文件中继续输入',
  ...
  'zh-TW': {
    pane: {
      ...
      focusPreview: '聚焦檔案', restorePreview: '還原分欄', moveComposer: '拖到檔案中繼續輸入',
  ...
  en: {
    pane: {
      ...
      focusPreview: 'Focus file', restorePreview: 'Restore split view', moveComposer: 'Drag into the file to continue typing',
