...
export type SettingsPreferencesCopy = {
  ...
  appearance: {
    ...
    fontSize: {
      ...
      ui: Record<'compact' | 'default' | 'large' | 'xlarge', string>;
    };
  };
  pets: {
    import: string;
...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  zh: {
    ...
    appearance: {
      ...
      fontSize: { uiLabel: '界面', terminalLabel: '终端', ui: { compact: '紧凑', default: '标准', large: '大', xlarge: '特大' } },
    },
    pets: {
