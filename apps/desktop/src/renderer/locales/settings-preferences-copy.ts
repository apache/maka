...
export type SettingsPreferencesCopy = {
  ...
  general: {
    ...
    defaultWorkingDirectoryHelp: string;
    chooseDefaultWorkingDirectory: string;
    clearDefaultWorkingDirectory: string;
    saveDefaultWorkingDirectoryFailed: string;
    proxy: string;
    proxyHelp: string;
    enableProxy: string;
...
const SETTINGS_PREFERENCES_COPY_BY_LOCALE = {
  zh: {
    ...
    sections: {
      ...
      chatDefaults: '对话默认', chatDefaultsHelp: '新对话的起始模型、权限模式与思考级别。',
    ...
    general: {
      ...
      defaultModel: '默认模型', defaultModelHelp: '新对话默认使用的模型。', notSet: '未设置', saveDefaultModelFailed: '保存默认模型失败', defaultPermission: '默认权限模式', defaultPermissionHelp: '新对话默认使用的权限模式；可在对话内随时切换。', saveDefaultPermissionFailed: '保存默认权限模式失败', defaultThinking: '默认思考级别', defaultThinkingHelp: '新对话的思考级别；当前模型不支持所选级别时用模型默认。', followModelDefault: '跟随模型默认', saveDefaultThinkingFailed: '保存默认思考级别失败', defaultWorkingDirectory: '默认工作目录', defaultWorkingDirectoryHelp: '没有指定项目或文件夹的新对话与 Bot 对话使用此目录。', chooseDefaultWorkingDirectory: '选择文件夹', clearDefaultWorkingDirectory: '清除', saveDefaultWorkingDirectoryFailed: '保存默认工作目录失败',
  ...
  en: {
    ...
    sections: {
      ...
      chatDefaults: 'Conversation defaults', chatDefaultsHelp: 'The model, permission mode, and thinking level a new conversation starts on.',
