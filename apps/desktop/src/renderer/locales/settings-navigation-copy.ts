...
const SETTINGS_NAVIGATION_COPY_BY_LOCALE = {
  zh: {
    ...
    sections: {
      ...
      projects: { label: '工作区', description: '选择 Runtime Host，并管理该 Host 上的项目。' },
      ...
      tasks: { label: '任务管理', description: '批量归档、恢复与彻底删除任务，以及从其他工具导入。' },
  ...
  en: {
    ...
    sections: {
      ...
      tasks: { label: 'Manage tasks', description: 'Archive, restore, and permanently delete tasks in bulk, and import from other tools.' },
