...
const SETTINGS_NAVIGATION_COPY_BY_LOCALE = {
  'zh-CN': {
    ...
    sections: {
      ...
      'computer-history': { label: '电脑历史', description: '本机活动记录、系统权限、排除规则与数据保留。' },
  ...
  'zh-TW': {
    ...
    sections: {
      ...
      'computer-history': { label: '電腦歷史', description: '本機活動記錄、系統權限、排除規則與資料保留。' },
  ...
  en: {
    ...
    sections: {
      ...
      'computer-history': { label: 'Computer history', description: 'Local activity recording, system permissions, exclusions, and data retention.' },
