...
const en = {
  ...
  authenticationLoading: 'Reading sign-in verification…',
  authenticationReadFailed: 'Sign-in verification could not be read. Check the Host connection and retry.',
  retryAuthenticationRead: 'Refresh sign-in status',
  ...
  unchecked: 'Connection has not been checked.',
  connecting: 'Connecting…',
  awaiting_authorization: 'Complete Google sign-in in your browser.',
  cancelling: 'Cancelling and releasing the process…',
  connected: 'Connection successful.',
  authenticated: 'Google sign-in verified.',
  cancelled: 'Setup cancelled.',
  error: 'The operation failed. Check the saved path and Host connection, then retry.',
  failures: {
    proxy_unsupported: 'Antigravity 1.1.1 does not support the configured SOCKS proxy. Choose an HTTP or HTTPS proxy in Maka network settings.',
    proxy_credentials_missing: 'The Maka proxy credentials are missing. Complete the network settings and retry.',
...
const zh = {
  ...
  authenticationLoading: '正在读取登录验证状态…',
  authenticationReadFailed: '无法读取登录验证状态，请检查 Host 连接后重试。',
  retryAuthenticationRead: '刷新登录状态',
  ...
  connected: '连接成功。',
  authenticated: '已验证 Google 登录。',
  cancelled: '已取消设置操作。',
  error: '操作失败，请检查已保存路径和 Host 连接后重试。',
  failures: {
    proxy_unsupported: 'Antigravity 1.1.1 不支持当前 SOCKS 代理，请在 Maka 网络设置中配置 HTTP 或 HTTPS 代理。',
    proxy_credentials_missing: 'Maka 代理凭据缺失，请完善网络设置后重试。',
...
const zhTW: typeof en = {
  ...
  authenticationLoading: '正在讀取登入驗證狀態…',
  authenticationReadFailed: '無法讀取登入驗證狀態，請檢查 Host 連線後重試。',
  retryAuthenticationRead: '重新整理登入狀態',
  ...
  connected: '連線成功。',
  authenticated: '已驗證 Google 登入。',
  cancelled: '已取消設定操作。',
  error: '操作失敗，請檢查已儲存路徑和 Host 連線後重試。',
  failures: {
    proxy_unsupported: 'Antigravity 1.1.1 不支援目前的 SOCKS 代理，請在 Maka 網路設定中設定 HTTP 或 HTTPS 代理。',
    proxy_credentials_missing: 'Maka 代理憑證缺失，請完成網路設定後重試。',
