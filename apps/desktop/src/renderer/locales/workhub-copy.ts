...
export interface WorkHubCopy {
  ...
  readonly stopOutcomes: Record<
    ...
    string
  >;
  readonly resumeRequested: string;
  readonly resumeOutcomes: Record<'resume_started' | 'already_running', string>;
  readonly resumeTargetRequired: string;
  readonly resumeTargetAmbiguous: string;
  readonly resumeTargetUnavailable: string;
  readonly resumeOperationUnavailable: string;
  readonly resumeHostRecovering: string;
