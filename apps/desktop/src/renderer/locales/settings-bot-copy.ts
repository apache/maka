...
const zhCopy = {
  providers: {
    ...
    whatsapp: { label: 'WhatsApp', help: '扫描二维码，将 Maka 关联为 WhatsApp 设备' },
  ...
  page: {
    ...
    disconnectWhatsappTitle: '断开 WhatsApp 关联？', disconnectWhatsappDescription: '将清除本机保存的关联设备凭据，之后需要重新扫码才能继续使用 WhatsApp 渠道。',
    disconnect: '断开登录', cancel: '取消', disconnected: '微信登录已断开', whatsappDisconnected: 'WhatsApp 关联已断开', credentialsCleared: '本机关联凭据已清除。',
  },
  detail: {
    ...
    actionsAria: (name: string) => `${name}渠道操作`, quickBind: '快捷绑定', scanLogin: '扫码登录', scanConnect: '扫码接入', disconnecting: '断开中…', disconnectWechat: '断开微信登录', disconnectWhatsapp: '断开 WhatsApp 关联', bridgeQr: '本机桥接二维码',
    ...
    quickWhatsappTitle: '关联 WhatsApp 设备', quickWhatsappDetail: '使用手机 WhatsApp 扫码；multi-device auth state 仅保存在本机。',
    whatsappProtocolNotice: 'WhatsApp 未提供面向个人账号自动化的官方 Bot API；此渠道通过关联设备 Web protocol 工作，可能受平台策略变更影响。建议使用专用账号并自行评估账号风险。',
  ...
  onboarding: {
    providers: {
      ...
      whatsapp: { title: '关联 WhatsApp', ariaLabel: 'WhatsApp 扫码关联', qrAlt: 'WhatsApp 关联二维码', subtitle: '使用 WhatsApp 扫描二维码关联本机', waiting: '打开 WhatsApp 的关联设备并扫描二维码', scanned: '已扫码，正在完成设备关联' },
    },
...
const enCopy: BotSettingsCopy = {
  providers: {
    ...
    slack: { label: 'Slack', help: 'Connect with a Bot Token and App-Level Token over Socket Mode' }, whatsapp: { label: 'WhatsApp', help: 'Scan a QR code to link Maka as a WhatsApp device' },
  },
  readiness: {
