...
const CAPABILITY_REASON_COPY = {
  'zh-CN': {
    ...
    cu_backend_status: 'Cua Driver 已通过本地完整性检查。',
    cu_backend_unavailable: 'Computer Use 后端当前不可用。',
    cu_executor_undistributable: '未找到通过完整性检查且可分发的 Cua Driver。',
    cu_executor_stopped: 'Cua Driver 已停止。',
    cu_executor_start_failed: 'Cua Driver 启动失败或已退出。',
    cu_executor_recovering: 'Cua Driver 正在启动或恢复。',
    cu_executor_ready: 'Cua Driver 已就绪。',
    cu_executor_lazy_start: 'Cua Driver 已可用，将在首次调用时启动。',
  ...
  'zh-TW': {
    ...
    cu_backend_status: 'Cua Driver 已通過本機完整性檢查。',
    cu_backend_unavailable: 'Computer Use 後端目前無法使用。',
    cu_executor_undistributable: '找不到通過完整性檢查且可分發的 Cua Driver。',
    cu_executor_stopped: 'Cua Driver 已停止。',
    cu_executor_start_failed: 'Cua Driver 啟動失敗或已退出。',
    cu_executor_recovering: 'Cua Driver 正在啟動或恢復。',
    cu_executor_ready: 'Cua Driver 已就緒。',
    cu_executor_lazy_start: 'Cua Driver 已可用，將在首次呼叫時啟動。',
  ...
  en: {
    ...
    cu_backend_status: 'The Cua Driver artifact passed the local integrity check.',
    cu_backend_unavailable: 'The Computer Use backend is currently unavailable.',
    cu_executor_undistributable: 'No distributable Cua Driver passed the integrity check.',
    cu_executor_stopped: 'The Cua Driver has stopped.',
    cu_executor_start_failed: 'The Cua Driver failed to start or has exited.',
    cu_executor_recovering: 'The Cua Driver is starting or recovering.',
    cu_executor_ready: 'The Cua Driver is ready.',
    cu_executor_lazy_start: 'Cua Driver is available and starts on first use.',
