...
const CAPABILITY_REASON_COPY = {
  'zh-CN': {
    ...
    cu_platform_unsupported: '当前平台不支持 Computer Use，未提供该平台的执行器。',
  ...
  'zh-TW': {
    ...
    cu_platform_unsupported: '目前平台不支援 Computer Use，未提供該平台的執行器。',
  ...
  en: {
    ...
    cu_platform_unsupported: 'Computer Use is not supported on this platform, and no executor is provisioned for it.',
