  ...
  'zh-TW': {
    runtimeHost: {
      ...
      managementError: {
        ...
        update_incomplete: '更新未完成，請查看服務記錄',
        service_manager_operation_failed: '系統服務管理器操作失敗，請查看服務記錄',
        uninstall_incomplete: '解除安裝未完成，請重試',
        deployment_io_failed: '無法寫入 Runtime Host 部署檔案',
        deployment_commit_unknown: '請查看服務記錄了解詳細資訊',
