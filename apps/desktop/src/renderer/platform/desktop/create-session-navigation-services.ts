...
import type { SessionNavigationServices } from '../../features/session-navigation';

export type DesktopSessionNavigationBridge = Pick<MakaBridge, 'sessions'>;

/** The only Desktop bridge adapter used by Session Navigation. */
export function createDesktopSessionNavigationServices(
