...
export function runtimeHostOAuthAuthorizationBridge(
  ...
  return {
    ...
    // Whether this provider may enrol on the selected Host is the Host's
    // answer, so the surface asks it rather than keeping a second local copy.
