...
function SettingsSurfaceContent(
  ...
  function configureComputerHistoryModel(): void {
    const profileId = computerHistoryModelSettingsProfile(runtimeHosts, runtimeHostCatalogStatus);
    if (!profileId) {
      toast.error(copy.runtimeHostUnavailable, runtimeHostCatalogStatus.message);
      return;
    }
