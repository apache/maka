...
/**
 * Pure-data provider introduction copy, localized by supported UI locale.
 *
 ...
 * …>` fails the build when a registered provider has no locale entry.
 */
...
export const PROVIDER_DISPLAY_COPY = {
  ...
  en: 'This provider is not registered in the current build.',
  ko: '현재 빌드에 등록되지 않은 공급자입니다.'
} satisfies UiCatalog<string>;
export const PROVIDER_DISPLAY_COPY = {
  'kimi-coding-plan': {
    'zh-CN': {
      name: 'Kimi Coding Plan',
      description: '月之暗面 · Anthropic 兼容',
      badge: 'Coding'
    },
    en: {
      name: 'Kimi Coding Plan',
      description: 'Moonshot · Anthropic-compatible',
      badge: 'Coding'
    },
    ko: {
      name: 'Kimi Coding Plan',
  ...
  'minimax-coding-plan': {
    'zh-CN': {
      ...
      description: 'MiniMax Coding 套餐 · Anthropic 兼容',
      badge: 'Coding'
    },
    en: {
      name: 'MiniMax Coding Plan',
      description: 'MiniMax coding plan · Anthropic-compatible',
      badge: 'Coding'
    },
    ko: {
      name: 'MiniMax Coding Plan',
  ...
  deepseek: {
    'zh-CN': {
      name: 'DeepSeek',
      description: 'DeepSeek 官方接入',
      badge: 'API'
    },
    en: {
      name: 'DeepSeek',
      description: 'Official DeepSeek API access.',
      badge: 'API'
    },
    ko: {
      name: 'DeepSeek',
  ...
  moonshot: {
    'zh-CN': {
      name: 'Moonshot',
      description: 'Moonshot 官方接入',
      badge: 'API'
    },
    en: {
      name: 'Moonshot',
      description: 'Official Moonshot API access.',
      badge: 'API'
    },
    ko: {
      name: 'Moonshot',
  ...
  'zai-coding-plan': {
    'zh-CN': {
      ...
      description: '智谱 · OpenAI 兼容',
      badge: 'Coding'
    },
    en: {
      name: 'Z.AI Coding Plan',
      description: 'Zhipu · OpenAI-compatible',
      badge: 'Coding'
    },
    ko: {
      name: 'Z.AI Coding Plan',
  ...
  MiniMax: {
    'zh-CN': {
      name: 'MiniMax',
      description: 'MiniMax · Anthropic 兼容',
      badge: 'API'
    },
    en: {
      name: 'MiniMax',
  ...
  'MiniMax-cn': {
    'zh-CN': {
      name: 'MiniMax 中国站',
      description: 'MiniMax 中国站 · Anthropic 兼容',
      badge: 'API'
    },
    en: {
      name: 'MiniMax China',
      description: 'MiniMax China · Anthropic-compatible',
      badge: 'API'
    },
    ko: {
      name: 'MiniMax China',
  ...
  siliconflow: {
    'zh-CN': {
      name: 'SiliconFlow',
      description: '硅基流动多模型 API，支持精确模型 ID。',
      badge: '聚合'
    },
    en: {
      name: 'SiliconFlow',
  ...
  anthropic: {
    'zh-CN': {
      name: 'Anthropic',
      description: 'Anthropic 官方接入',
      badge: 'API'
    },
    en: {
      name: 'Anthropic',
      description: 'Official Anthropic API access.',
      badge: 'API'
    },
    ko: {
      name: 'Anthropic',
  ...
  google: {
    'zh-CN': {
      name: 'Google Gemini',
      description: 'Google AI Studio 接入',
      badge: 'API'
    },
    en: {
      name: 'Google Gemini',
      description: 'Google AI Studio API access.',
      badge: 'API'
    },
    ko: {
      name: 'Google Gemini',
  ...
  xai: {
    'zh-CN': {
      name: 'xAI',
      description: 'xAI 官方接入，Grok 系列模型',
      badge: 'API'
    },
    en: {
      name: 'xAI',
      description: 'Official xAI API access for Grok models.',
      badge: 'API'
    },
    ko: {
      name: 'xAI',
  ...
  zai: {
    'zh-CN': {
      name: 'Z.AI',
      description: '智谱官方接入，GLM 系列模型',
      badge: 'API'
    },
    en: {
      name: 'Z.AI',
      description: 'Official Z.AI API access for GLM models.',
      badge: 'API'
    },
    ko: {
      name: 'Z.AI',
  ...
  xiaomi: {
    'zh-CN': {
      name: 'Xiaomi',
      description: '小米官方接入，MiMo 系列模型',
      badge: 'API'
    },
    en: {
      name: 'Xiaomi',
      description: 'Official Xiaomi API access for MiMo models.',
      badge: 'API'
    },
    ko: {
      name: 'Xiaomi',
  ...
  'xiaomi-token-plan-cn': {
    'zh-CN': {
      name: 'Xiaomi Token Plan 中国',
      description: '小米 MiMo Token Plan 订阅 · 中国 · 编码工具',
      badge: 'Token'
    },
    en: {
      name: 'Xiaomi Token Plan (China)',
      description: 'Xiaomi MiMo Token Plan subscription (China) for coding tools.',
      badge: 'Token'
    },
    ko: {
      name: 'Xiaomi Token Plan (China)',
  ...
  'xiaomi-token-plan-sgp': {
    'zh-CN': {
      name: 'Xiaomi Token Plan 新加坡',
      description: '小米 MiMo Token Plan 订阅 · 新加坡 · 编码工具',
      badge: 'Token'
    },
    en: {
      name: 'Xiaomi Token Plan (Singapore)',
      description: 'Xiaomi MiMo Token Plan subscription (Singapore) for coding tools.',
      badge: 'Token'
    },
    ko: {
      name: 'Xiaomi Token Plan (Singapore)',
  ...
  'xiaomi-token-plan-ams': {
    'zh-CN': {
      name: 'Xiaomi Token Plan 欧洲',
      description: '小米 MiMo Token Plan 订阅 · 欧洲 · 编码工具',
      badge: 'Token'
    },
    en: {
      name: 'Xiaomi Token Plan (Europe)',
      description: 'Xiaomi MiMo Token Plan subscription (Europe) for coding tools.',
      badge: 'Token'
    },
    ko: {
      name: 'Xiaomi Token Plan (Europe)',
  ...
  cerebras: {
    'zh-CN': {
      name: 'Cerebras',
      description: '高速推理托管开源模型',
      badge: 'API'
    },
    en: {
      name: 'Cerebras',
      description: 'Fast hosted open-model inference.',
      badge: 'API'
    },
    ko: {
      name: 'Cerebras',
  ...
  mistral: {
    'zh-CN': {
      name: 'Mistral',
      description: 'Mistral 官方接入',
      badge: 'API'
    },
    en: {
      name: 'Mistral',
      description: 'Official Mistral API access.',
      badge: 'API'
    },
    ko: {
      name: 'Mistral',
  ...
  togetherai: {
    'zh-CN': {
      name: 'Together AI',
      description: '托管开源模型 API',
      badge: 'API'
    },
    en: {
      name: 'Together AI',
      description: 'Hosted open models over one API.',
      badge: 'API'
    },
    ko: {
      name: 'Together AI',
  ...
  ollama: {
    'zh-CN': {
      name: 'Ollama',
      description: '本机运行 · 离线可用',
      badge: 'Local'
    },
    en: {
      name: 'Ollama',
      description: 'Runs locally · works offline',
      badge: 'Local'
    },
    ko: {
      name: 'Ollama',
  ...
  'lm-studio': {
    'zh-CN': {
      name: 'LM Studio',
      description: '本机 LM Studio 服务 · 离线可用',
      badge: 'Local'
    },
    en: {
      name: 'LM Studio',
  ...
  localai: {
    'zh-CN': {
      name: 'LocalAI',
      description: '本机 LocalAI 服务，可选密钥保护',
      badge: 'Local'
    },
    en: {
      name: 'LocalAI',
      description: 'Local models served by LocalAI, with optional API key.',
      badge: 'Local'
    },
    ko: {
      name: 'LocalAI',
  ...
  'openai-compatible': {
    'zh-CN': {
      ...
      description: 'OpenAI Chat Completions 兼容中转站、代理服务或自部署网关。',
      badge: '中转'
    },
    en: {
      name: 'Custom relay (OpenAI Chat)',
      description: 'OpenAI Chat Completions-compatible relay, proxy, or self-hosted gateway.',
      badge: 'Relay'
    },
    ko: {
      name: 'Custom relay (OpenAI Chat)',
  ...
  'openai-responses-compatible': {
    'zh-CN': {
      ...
      description: 'OpenAI Responses API 兼容中转站、代理服务或自部署网关。',
      badge: 'Responses'
    },
    en: {
      name: 'Custom relay (OpenAI Responses)',
      description: 'OpenAI Responses-compatible relay, proxy, or self-hosted gateway.',
      badge: 'Responses'
    },
    ko: {
      name: 'Custom relay (OpenAI Responses)',
  ...
  'anthropic-compatible': {
    'zh-CN': {
      ...
      description: 'Anthropic Messages 兼容中转站、代理服务或自部署网关。',
      badge: 'Anthropic'
    },
    en: {
      name: 'Custom relay (Anthropic)',
      description: 'Anthropic Messages-compatible relay, proxy, or self-hosted gateway.',
      badge: 'Anthropic'
    },
    ko: {
      name: 'Custom relay (Anthropic)',
  ...
  nvidia: {
    'zh-CN': {
      name: 'NVIDIA',
      description: 'NVIDIA 官方托管模型接入',
      badge: 'API'
    },
    en: {
      name: 'NVIDIA',
      description: 'NVIDIA-hosted models API access.',
      badge: 'API'
    },
    ko: {
      name: 'NVIDIA',
  ...
  'tencent-tokenhub': {
    'zh-CN': {
      ...
      description: '腾讯云 TokenHub 按量接入，混元等模型',
      badge: 'API'
    },
    en: {
      name: 'Tencent TokenHub',
      description: 'Tencent Cloud TokenHub pay-as-you-go access.',
      badge: 'API'
    },
    ko: {
      name: 'Tencent TokenHub',
  ...
  stepfun: {
    'zh-CN': {
      name: 'StepFun 中国站',
      description: '阶跃星辰官方接入 · 中国站',
      badge: 'API'
    },
    en: {
      name: 'StepFun (China)',
      description: 'Official StepFun China API access.',
      badge: 'API'
    },
    ko: {
      name: 'StepFun (China)',
  ...
  'tencent-coding-plan': {
    'zh-CN': {
      ...
      description: '腾讯云 Coding 套餐 · OpenAI 兼容',
      badge: 'Coding'
    },
    en: {
      name: 'Tencent Coding Plan',
      description: 'Tencent Cloud coding plan · OpenAI-compatible',
      badge: 'Coding'
    },
    ko: {
      name: 'Tencent Coding Plan',
  ...
  'stepfun-ai': {
    'zh-CN': {
      name: 'StepFun 国际站',
      description: '阶跃星辰官方接入 · 国际站',
      badge: 'API'
    },
    en: {
      name: 'StepFun (Global)',
      description: 'Official StepFun Global API access.',
      badge: 'API'
    },
    ko: {
      name: 'StepFun (Global)',
  ...
  'volcengine-ark': {
    'zh-CN': {
      name: '火山方舟',
      description: '火山引擎官方接入，豆包等模型',
      badge: 'API'
    },
    en: {
      name: 'Volcengine Ark (China)',
      description: 'Volcengine Ark direct API access in China.',
      badge: 'API'
    },
    ko: {
      name: 'Volcengine Ark (China)',
  ...
  'volcengine-coding-plan': {
    'zh-CN': {
      ...
      description: '火山引擎 Coding 订阅 · OpenAI 兼容',
      badge: 'Coding'
    },
    en: {
      name: 'Volcengine Ark Coding Plan (China)',
      description: 'Volcengine Ark coding subscription · OpenAI-compatible',
      badge: 'Coding'
    },
    ko: {
      name: 'Volcengine Ark Coding Plan (China)',
  ...
  'volcengine-agent-plan': {
    'zh-CN': {
      ...
      description: '火山引擎 Agent 订阅 · Responses API',
      badge: 'Agent'
    },
    en: {
      name: 'Volcengine Ark Agent Plan (China)',
      description: 'Volcengine Ark agent subscription · Responses API',
      badge: 'Agent'
    },
    ko: {
      name: 'Volcengine Ark Agent Plan (China)',
  ...
  'tencent-token-plan': {
    'zh-CN': {
      ...
      description: '腾讯云 Token 套餐，个人智能体与编码工具',
      badge: 'Token'
    },
    en: {
      name: 'Tencent Token Plan',
      description: 'Tencent Cloud token plan for personal agents and coding tools.',
      badge: 'Token'
    },
    ko: {
      name: 'Tencent Token Plan',
  ...
  'stepfun-step-plan': {
    'zh-CN': {
      name: 'StepFun Step Plan 中国站',
      description: '阶跃星辰订阅套餐 · 中国站',
      badge: 'Plan'
    },
    en: {
      name: 'StepFun Step Plan (China)',
      description: 'StepFun China subscription for coding and agent tools.',
      badge: 'Plan'
    },
    ko: {
      name: 'StepFun Step Plan (China)',
  ...
  deepinfra: {
    'zh-CN': {
      name: 'DeepInfra',
      description: '开源模型托管推理 · OpenAI 兼容',
      badge: 'API'
    },
    en: {
      name: 'DeepInfra',
      description: 'Hosted open-model inference · OpenAI-compatible',
      badge: 'API'
    },
    ko: {
      name: 'DeepInfra',
  ...
  cohere: {
    'zh-CN': {
      name: 'Cohere',
      description: 'Cohere 官方接入',
      badge: 'API'
    },
    en: {
      name: 'Cohere',
      description: 'Official Cohere Chat API access.',
      badge: 'API'
    },
    ko: {
      name: 'Cohere',
  ...
  'stepfun-ai-step-plan': {
    'zh-CN': {
      name: 'StepFun Step Plan 国际站',
      description: '阶跃星辰订阅套餐 · 国际站',
      badge: 'Plan'
    },
    en: {
      name: 'StepFun Step Plan (Global)',
      description: 'StepFun Global subscription for coding and agent tools.',
      badge: 'Plan'
    },
    ko: {
      name: 'StepFun Step Plan (Global)',
  ...
  'cloudflare-workers-ai': {
    'zh-CN': {
      ...
      description: 'Cloudflare 托管模型，账户级接入',
      badge: 'API'
    },
    en: {
      name: 'Cloudflare Workers AI',
      description: 'Cloudflare-hosted models over the account-scoped API.',
      badge: 'API'
    },
    ko: {
      name: 'Cloudflare Workers AI',
  ...
  huggingface: {
    'zh-CN': {
      name: 'Hugging Face',
      description: 'Inference Providers 路由，聚合多家托管模型',
      badge: '路由'
    },
    en: {
      name: 'Hugging Face',
      description: 'Inference Providers router across hosted models.',
      badge: 'Router'
    },
    ko: {
      name: 'Hugging Face',
  ...
  opencode: {
    'zh-CN': {
      name: 'OpenCode Zen',
      description: '面向编码智能体的按量模型精选',
      badge: 'Plan'
    },
    en: {
      name: 'OpenCode Zen',
      description: 'Curated pay-as-you-go models for coding agents.',
      badge: 'Plan'
    },
    ko: {
      name: 'OpenCode Zen',
  ...
  'opencode-go': {
    'zh-CN': {
      name: 'OpenCode Go',
      description: '低价订阅制的开源编码模型精选',
      badge: 'Plan'
    },
    en: {
      name: 'OpenCode Go',
      description: 'Low-cost subscription to curated open coding models.',
      badge: 'Plan'
    },
    ko: {
      name: 'OpenCode Go',
  ...
  groq: {
    'zh-CN': {
      name: 'Groq',
      description: 'LPU 高速推理托管开源模型',
      badge: 'API'
    },
    en: {
      name: 'Groq',
      description: 'Ultra-fast LPU-hosted open models.',
      badge: 'API'
    },
    ko: {
      name: 'Groq',
  ...
  openrouter: {
    'zh-CN': {
      name: 'OpenRouter',
      description: '一个密钥接入各大模型厂商 · OpenAI 兼容',
      badge: '聚合'
    },
    en: {
      name: 'OpenRouter',
      description: 'One API key across all major model labs · OpenAI-compatible',
      badge: 'Aggregator'
    },
    ko: {
      name: 'OpenRouter',
  ...
  alibaba: {
    'zh-CN': {
      name: 'Alibaba',
      description: '阿里云百炼接入，通义千问 Qwen 模型',
      badge: 'API'
    },
    en: {
      name: 'Alibaba',
      description: 'Alibaba Cloud API access for Qwen models.',
      badge: 'API'
    },
    ko: {
      name: 'Alibaba',
  ...
  'alibaba-cn': {
    'zh-CN': {
      name: 'Alibaba 中国站',
      description: '阿里云百炼中国站接入，通义千问 Qwen 模型',
      badge: 'API'
    },
    en: {
      name: 'Alibaba (China)',
  ...
  'alibaba-coding-plan-cn': {
    'zh-CN': {
      name: 'Alibaba Coding Plan 中国站',
      description: '阿里云百炼 Coding Plan 订阅 · 中国站',
      badge: 'Plan'
    },
    en: {
      name: 'Alibaba Coding Plan (China)',
      description: 'Alibaba Cloud Model Studio Coding Plan for interactive coding tools · China.',
      badge: 'Plan'
    },
    ko: {
      name: 'Alibaba Coding Plan (China)',
  ...
  'alibaba-coding-plan': {
    'zh-CN': {
      name: 'Alibaba Coding Plan 国际站',
      description: '阿里云百炼 Coding Plan 订阅 · 国际站',
      badge: 'Plan'
    },
    en: {
      name: 'Alibaba Coding Plan',
      description: 'Alibaba Cloud Model Studio Coding Plan for interactive coding tools.',
      badge: 'Plan'
    },
    ko: {
      name: 'Alibaba Coding Plan',
  ...
  'alibaba-token-plan-cn': {
    'zh-CN': {
      ...
      description: '阿里云百炼 Token Plan 订阅，交互式智能体与编码工具 · 北京',
      badge: 'Token'
    },
    en: {
      name: 'Alibaba Token Plan (China)',
      description: 'Alibaba Cloud Model Studio Token Plan for interactive agents and coding tools, Beijing region.',
      badge: 'Token'
    },
    ko: {
      name: 'Alibaba Token Plan (China)',
  ...
  'alibaba-token-plan': {
    'zh-CN': {
      name: 'Alibaba Token Plan（团队版）',
      description: '阿里云百炼 Token Plan 订阅，交互式智能体与编码工具 · 新加坡',
      badge: 'Token'
    },
    en: {
      name: 'Alibaba Token Plan',
      description: 'Alibaba Cloud Model Studio Token Plan for interactive agents and coding tools, Singapore region.',
      badge: 'Token'
    },
    ko: {
      name: 'Alibaba Token Plan',
  ...
  'github-copilot': {
    'zh-CN': {
      name: 'GitHub Copilot',
      description: 'GitHub Copilot 订阅接入，复用本机 GitHub 登录',
      badge: 'Account'
    },
    en: {
      name: 'GitHub Copilot',
      description: 'GitHub Copilot subscription access using an existing GitHub login.',
      badge: 'Account'
    },
    ko: {
      name: 'GitHub Copilot',
  ...
  'claude-subscription': {
    'zh-CN': {
      ...
      description: 'Claude Pro / Max 订阅账号登录；登录后自动成为可用模型连接。'
    },
    en: {
      name: 'Claude Subscription',
      description: 'Sign in with a Claude Pro / Max subscription; it becomes an available model connection once signed in.'
    },
    ko: {
      name: 'Claude Subscription',
      description: 'Sign in with a Claude Pro / Max subscription; it becomes an available model connection once signed in.'
  ...
  'openai-codex': {
    'zh-CN': {
      name: 'OpenAI OAuth',
      description: 'ChatGPT / Codex 账号登录；登录后自动成为可用模型连接。'
    },
    en: {
      name: 'OpenAI OAuth',
      description: 'Sign in with a ChatGPT / Codex account; it becomes an available model connection once signed in.'
    },
    ko: {
      name: 'OpenAI OAuth',
      description: 'Sign in with a ChatGPT / Codex account; it becomes an available model connection once signed in.'
...
export function providerDisplay(type: ProviderType, locale: UiLocale): ProviderCopy {
  ...
  if (copy && locale === 'ko') return koreanProviderDisplay(type, copy);
  return copy ?? {
    name: type,
    description: UNKNOWN_PROVIDER_DESCRIPTION[locale]
  };
}

function koreanProviderDisplay(type: ProviderType, copy: ProviderCopy): ProviderCopy {
  const name = copy.name;
  const description = copy.description;
  const localizedDescription = /API access|API$/u.test(description)
    ? `${name} 공식 API 연결`
    : /subscription|plan|Token|Plan/u.test(description)
      ? `${name} 구독 플랜 연결`
      : /locally|Local models|offline/u.test(description)
        ? `${name} 로컬 모델 연결`
        : /gateway|relay|router|Hosted|hosted/u.test(description)
          ? `${name} 호스팅 모델 연결`
          : `${name} 모델 연결`;
  const badge = copy.badge === 'Coding'
    ? '코딩'
    : copy.badge === 'Aggregator'
      ? '애그리게이터'
      : copy.badge === 'Gateway'
        ? '게이트웨이'
        : copy.badge === 'Responses'
          ? 'Responses'
          : copy.badge === 'Router'
            ? '라우터'
            : copy.badge === 'Relay'
                  ...
                  : copy.badge === 'Free'
                    ...
                    : copy.badge === 'Account'
                      ...
                      : copy.badge === 'Local'
                        ? '로컬'
                        : copy.badge;
  return { name, description: localizedDescription, ...(badge ? { badge } : {}) };
}
