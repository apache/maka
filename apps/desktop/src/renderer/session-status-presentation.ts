...
/**
 * Renderer-side presentation rules that only Desktop has: how session summaries
 * enter renderer state, and what to offer after a turn fails.
 *
...
import { isActionableBlocked, type SessionSummary } from '@maka/core/session';
