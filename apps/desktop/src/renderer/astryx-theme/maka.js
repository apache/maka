...
export const makaTheme = {
  ...
  __localTokenLineage: ["neutral","maka"],
  components: {
    "heading": {
      "level:1": {
  ...
  __axes: {
    "typography": {
      ...
      "body": {
        "family": "-apple-system",
        "fallbacks": "BlinkMacSystemFont, system-ui, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Microsoft YaHei UI\", \"Noto Sans CJK SC\", \"Noto Sans SC\", \"WenQuanYi Micro Hei\", \"Source Han Sans SC\", \"Geist Variable\", sans-serif"
      },
      "heading": {},
      "code": {
        "family": "Geist Mono Variable",
        "fallbacks": "\"JetBrains Mono\", ui-monospace, SFMono-Regular, \"SF Mono\", Menlo, Consolas, \"Liberation Mono\", monospace"
      }
    },
    "motion": {
      "fast": 125,
