...
const EN = {
  ...
  removeDescription: 'This deletes the activity interval and overlapping summaries, including evidence shared with other activities. This cannot be undone.',
  ...
  date: 'Activity date', today: 'Today', search: 'Search activities, windows or apps',
  ...
  empty: 'No history yet', emptyHelp: 'Recorded activities will appear here as they become available.',
  ...
  eventKinds: {
    ...
    'window.changed': 'Window changed', 'mouse.click': 'Click', 'mouse.drag': 'Drag',
...
const ZH: Copy = {
  ...
  eventKinds: {
    ...
    'window.changed': '切换窗口', 'mouse.click': '点击', 'mouse.drag': '拖动',
...
const TW: Copy = {
  ...
  eventKinds: {
    ...
    'window.changed': '切換視窗', 'mouse.click': '點擊', 'mouse.drag': '拖曳',
