...
const EN = {
  ...
  permissionsReady: 'Accessibility and Input Monitoring are ready.',
  permissionsMissingBoth: 'Accessibility and Input Monitoring are required.',
  permissionsMissingAccessibility: 'Accessibility is required.',
  permissionsMissingInput: 'Input Monitoring is required.',
  permissionsUnknown: 'Permission status is unknown.',
  openPermissions: 'Go to permissions',
  ...
  textHelp: 'Store typed and selected text and accessibility field content locally. This may include private messages and documents. This does not authorize sending text to a model.',
  analysis: 'Allow model summaries',
  analysisHelp: 'Send app and window metadata to the analysis provider below. Token charges may apply. Turning this off stops new summary requests.',
  summaryText: 'Use recorded text in summaries',
  summaryTextHelp: 'Also send retained and future recorded text to the provider for {model}. It may include private messages and documents. Turning this off stops text use in new summaries, not local capture.',
  model: 'Summary model',
  modelAuthority: 'Shared with Daily Review on this Mac. Changes apply to both.',
  modelMissing: 'No analysis model configured',
  modelRequired: 'Choose an available model before enabling summaries.',
  configure: 'Manage connections',
  selectModel: 'Choose summary model',
  defaultModel: 'Follow this Mac’s default model',
  modelUnavailable: 'Unavailable',
  modelLoading: 'Loading models…',
  modelSaving: 'Saving model…',
  modelSaved: 'Model saved.',
  modelSaveFailed: 'Could not confirm the model change. Check the current selection and retry.',
  modelRetry: 'Retry model loading',
  modelReadFailed: 'Analysis model could not be read.',
  exclusions: 'Excluded sources',
  exclusionsHelp: 'Exclude these sources from future recording and summary analysis, including analysis of retained events. Existing events and summaries are not deleted.',
...
const COPY: Record<UiLocale, Copy> = {
  ...
  'zh-CN': {
    ...
    permissions: '系统权限', permissionsReady: '辅助功能与输入监控已就绪。',
    permissionsMissingBoth: '还需授权辅助功能与输入监控。', permissionsMissingAccessibility: '还需授权辅助功能。',
    permissionsMissingInput: '还需授权输入监控。', permissionsUnknown: '权限状态未知。',
    openPermissions: '前往授权', managePermissions: '管理权限',
    unsupported: '活动记录仅支持 macOS。', unavailable: '记录辅助程序不可用。',
    contentGroup: '内容与分析', text: '包含文本内容',
    textHelp: '在本机保存输入、选中的文本及辅助功能字段内容，可能包含私信和文档。此开关不授权将文本发送给模型。',
    analysis: '允许模型生成摘要',
    analysisHelp: '将应用和窗口元数据发送给下方分析模型的服务商，可能产生 token 费用。关闭后不再发送新的摘要请求。',
    summaryText: '将已记录文本用于摘要',
    summaryTextHelp: '同时将已保留及后续记录的文本发送给 {model} 的服务商，可能包含私信和文档。关闭仅停止文本用于后续摘要，不停止本机采集。',
    model: '摘要模型', modelAuthority: '与这台 Mac 的每日回顾共用；修改会同时影响两者。', modelMissing: '尚未配置分析模型',
    modelRequired: '请先选择可用模型，再开启摘要。', configure: '管理连接', modelReadFailed: '无法读取分析模型。',
    selectModel: '选择摘要模型', defaultModel: '跟随此 Mac 默认模型', modelUnavailable: '不可用',
    modelLoading: '正在读取模型…', modelSaving: '正在保存模型…', modelSaved: '模型已保存。',
    modelSaveFailed: '未能确认模型更改，请检查当前选择后重试。', modelRetry: '重新读取模型',
    exclusions: '排除来源', exclusionsHelp: '这些来源不再参与后续记录和摘要分析，包括对保留事件的分析。已有事件和摘要不会删除。',
    ...
    cancel: '取消', confirm: '删除', deleted: '已删除历史。', saved: '已保存。', refresh: '刷新历史记录',
  ...
  'zh-TW': {
    ...
    permissions: '系統權限', permissionsReady: '輔助功能與輸入監控已就緒。',
    permissionsMissingBoth: '還需授權輔助功能與輸入監控。', permissionsMissingAccessibility: '還需授權輔助功能。',
    permissionsMissingInput: '還需授權輸入監控。', permissionsUnknown: '權限狀態未知。',
    openPermissions: '前往授權', managePermissions: '管理權限',
    unsupported: '活動記錄僅支援 macOS。', unavailable: '記錄輔助程式無法使用。',
    contentGroup: '內容與分析', text: '包含文字內容',
    textHelp: '在本機儲存輸入、選取的文字及輔助功能欄位內容，可能包含私訊和文件。此開關不授權將文字傳送給模型。',
    analysis: '允許模型產生摘要',
    analysisHelp: '將應用程式和視窗中繼資料傳送給下方分析模型的服務商，可能產生 token 費用。關閉後不再傳送新的摘要請求。',
    summaryText: '將已記錄文字用於摘要',
    summaryTextHelp: '同時將已保留及後續記錄的文字傳送給 {model} 的服務商，可能包含私訊和文件。關閉僅停止文字用於後續摘要，不停止本機擷取。',
    model: '摘要模型', modelAuthority: '與這台 Mac 的每日回顧共用；修改會同時影響兩者。', modelMissing: '尚未設定分析模型',
    modelRequired: '請先選擇可用模型，再開啟摘要。', configure: '管理連線', modelReadFailed: '無法讀取分析模型。',
    selectModel: '選擇摘要模型', defaultModel: '跟隨此 Mac 預設模型', modelUnavailable: '無法使用',
    modelLoading: '正在讀取模型…', modelSaving: '正在儲存模型…', modelSaved: '模型已儲存。',
    modelSaveFailed: '未能確認模型變更，請檢查目前選擇後重試。', modelRetry: '重新讀取模型',
    exclusions: '排除來源', exclusionsHelp: '這些來源不再參與後續記錄和摘要分析，包含對保留事件的分析。現有事件和摘要不會刪除。',
    ...
    cancel: '取消', confirm: '刪除', deleted: '已刪除歷史。', saved: '已儲存。', refresh: '重新整理歷史記錄',
