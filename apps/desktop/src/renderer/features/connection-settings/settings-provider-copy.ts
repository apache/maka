...
const zhCapabilitiesCopy = {
  ...
  contextWindow: '上下文窗口',
  contextWindowHelp: '按 token 数设置自动压缩阈值；留空不主动压缩。',
...
const zhTwCapabilitiesCopy = {
  ...
  contextWindow: '上下文視窗',
  contextWindowHelp: '以 token 數設定自動壓縮門檻；留空不主動壓縮。',
...
const enCapabilitiesCopy = {
  ...
  contextWindowHelp: 'Token threshold for automatic compaction. Leave empty to disable it.',
