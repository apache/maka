...
const zhCapabilitiesCopy = {
  ...
  maxOutputTokensHelp: '单次请求的输出 token 上限，含思考。留空自动设置。',
  fastMode: 'Fast 模式',
...
const zhTwCapabilitiesCopy = {
  ...
  maxOutputTokensHelp: '單次請求的輸出 token 上限，含思考。留空自動設定。',
  fastMode: 'Fast 模式',
...
const enCapabilitiesCopy = {
  ...
  maxOutputTokensHelp: 'Output token budget per request, including thinking. Leave empty for automatic limits.',
  fastMode: 'Fast mode',
