...
const zhCopy = {
  detail: {
    ...
    status: '连接状态', statusHealthy: '正常', statusUntested: '尚未测试',
    modelsSummary: (enabled: number, total: number) => `已启用 ${enabled} / ${total}`,
    filterModels: '筛选模型', noModelsMatch: '没有匹配的模型',
    enableModelAria: (name: string) => `启用模型 ${name}`,
    declareCapabilities: '声明能力', declareCapabilitiesAria: (name: string) => `声明能力：${name}`,
    modelUndescribed: 'Maka 不认识这个模型，请声明它的能力。',
  ...
  panel: {
    groups: { recommended: '推荐', plans: '模型计划', api: 'API', aggregators: '聚合服务', local: '本地' },
    loadFailed: '载入模型连接失败', loadingAria: '正在加载模型供应商', connections: '模型连接',
    connectionsHelp: '这些连接和它们启用的模型会出现在任务的模型选择器里。',
    ...
    emptyHelp: '先连接一个服务商。常用的几个就在下方，也可以浏览全部。', recommended: '推荐的服务商', browseAll: '查看全部服务商',
    ...
    searchPlaceholder: '搜索服务商', searchAria: '搜索模型服务商', noMatch: '没有匹配的服务商', clearSearch: '清除搜索',
  ...
  add: {
    ...
    stepsAria: '添加连接的步骤', stepCredentials: '密钥', stepModels: '选择模型',
    ...
    onboardingSelectedCount: (selected: number, total: number) => `已选 ${selected} / ${total}`, onboardingSelectAll: '全选', onboardingClearAll: '清空', onboardingNoModelsMatch: '没有匹配的模型',
    onboardingDefaultModel: '默认模型', onboardingDefaultModelHelp: '新任务默认使用这个模型；只能从已勾选的模型里选。',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    status: 'Connection status', statusHealthy: 'Healthy', statusUntested: 'Not tested yet',
    modelsSummary: (enabled: number, total: number) => `${enabled} of ${total} enabled`,
    filterModels: 'Filter models', noModelsMatch: 'No matching models',
    enableModelAria: (name: string) => `Enable model ${name}`,
    declareCapabilities: 'Declare capabilities', declareCapabilitiesAria: (name: string) => `Declare capabilities: ${name}`,
    modelUndescribed: 'Maka does not know this model. Declare its capabilities.',
  ...
  panel: {
    groups: { recommended: 'Recommended', plans: 'Model plans', api: 'API', aggregators: 'Aggregators', local: 'Local' },
    ...
    emptyHelp: 'Connect a provider first. The common ones are below, or browse them all.', recommended: 'Recommended providers', browseAll: 'Browse all providers',
  ...
  add: {
    ...
    onboardingSelectedCount: (selected: number, total: number) => `${selected} of ${total} selected`, onboardingSelectAll: 'Select all', onboardingClearAll: 'Clear', onboardingNoModelsMatch: 'No matching models',
