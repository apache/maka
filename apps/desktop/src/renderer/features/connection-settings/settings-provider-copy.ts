...
const zhCopy = {
  detail: {
    ...
    declareCapabilities: '补充规格', declareCapabilitiesAria: (name: string) => `补充规格：${name}`,
    modelUndescribed: 'Maka 没有这个模型的规格，请补充。',
...
const enCopy: ProviderSettingsCopy = {
  detail: {
    ...
    declareCapabilities: 'Add specs', declareCapabilitiesAria: (name: string) => `Add specs: ${name}`,
    modelUndescribed: 'Maka has no specs for this model. Add them.',
