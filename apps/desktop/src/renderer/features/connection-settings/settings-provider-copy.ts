...
const zhCapabilitiesCopy = {
  ...
  thinkingEffort: '思考档位',
  thinkingEffortHelp: '选择模型接受的思考强度，留空不覆盖。',
  thinkingUndeclared: '未声明',
  thinkingSelectedCount: (count: number) => `已选择 ${count} 个`,
  visionInput: '图片输入',
  visionInputHelp: '默认跟随服务商与模型资料，也可手动覆盖。',
  visionDefaultOption: (supported: boolean | undefined) =>
    supported === undefined ? '默认 · 待确认' : supported ? '默认 · 发送图片' : '默认 · 不发送图片',
...
const zhTwCapabilitiesCopy = {
  ...
  thinkingEffort: '思考檔位',
  thinkingEffortHelp: '選擇模型接受的思考強度，留空不覆寫。',
  thinkingUndeclared: '未宣告',
  thinkingSelectedCount: (count: number) => `已選擇 ${count} 個`,
  visionInput: '圖片輸入',
  visionInputHelp: '預設依服務商與模型資料，也可手動覆寫。',
  visionDefaultOption: (supported: boolean | undefined) =>
    supported === undefined ? '預設 · 待確認' : supported ? '預設 · 傳送圖片' : '預設 · 不傳送圖片',
...
const enCapabilitiesCopy = {
  ...
  thinkingEffort: 'Thinking levels',
  thinkingEffortHelp: 'Choose supported reasoning levels. Leave empty to keep the defaults.',
  thinkingUndeclared: 'Undeclared',
  thinkingSelectedCount: (count: number) => `${count} selected`,
  visionInput: 'Image input',
  visionInputHelp: 'Use provider and model information, or override it here.',
  visionDefaultOption: (supported: boolean | undefined) =>
    supported === undefined ? 'Default · Unconfirmed' : supported ? 'Default · Send images' : 'Default · No images',
...
const zhCopy = {
  detail: {
    ...
    addModelIdPlaceholder: 'deepseek/deepseek-v4-flash-0731',
