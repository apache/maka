...
export const workHubLiveCopy = {
  en: { filterConversation: 'Filter conversation by Work', clearConversationFilter: 'Show all conversations', noWorkConversation: 'No conversations for this Work in this part of history.', work: 'Work', attachmentLimit: 'Attachment count or size exceeds the limit', attachmentUploadFailed: 'Attachment upload did not return a reference', reviewAttachments: 'Please review the attachments.', sendFailed: 'Could not send',
    ...
    progressTitle: 'WorkHub progress', progressHint: 'You can keep working in Maka.', progressClose: 'Hide progress for this task',
    title: 'WorkHub', turnFailed: 'This turn failed. Details follow.',
    ...
    retry: 'Retry', selectModelToSend: 'Choose a model before sending.', configureModelToSend: 'Configure an available model before sending.', loadingModels: 'Loading models…', noModelsAvailable: 'No usable models are available.',
    ...
    stopAction: 'Stop', resumeAction: 'Resume', actionPending: 'Requested', actionFailed: 'Failed', stopDelivered: 'Stop delivered', alreadyTerminal: 'Already ended', pendingCancelled: 'Pending work cancelled', alreadyRunning: 'Already running', resumeStarted: 'Resume started',
    delegationAccepted: 'Accepted', delegationRunning: 'Running', delegationWaiting: 'Waiting for user',
  ...
  'zh-CN': { filterConversation: '筛选此 Work 的对话', clearConversationFilter: '显示全部对话', noWorkConversation: '这段历史中没有此 Work 的对话。', work: '工作', attachmentLimit: '附件数量或大小超过限制', attachmentUploadFailed: '附件上传失败', reviewAttachments: '请查看附件。', sendFailed: '发送失败',
    ...
    progressTitle: 'WorkHub 进度', progressHint: '你可以继续在 Maka 中操作。', progressClose: '本轮不再显示进度',
    title: '工作台', turnFailed: '本轮执行失败，详情如下。',
    progressInput: '补充一句…',
    float: '浮出工作台',
    dock: '收回 Maka',
    hide: '隐藏',
    ...
    retry: '重试', selectModelToSend: '请先选择模型', configureModelToSend: '请先配置可用模型', loadingModels: '正在加载模型…', noModelsAvailable: '暂无可用模型',
    reloadRequired: '工作台需要重新加载',
    welcome: '有什么可以帮你？',
    hint: '问个问题、管理任务，或让我帮你操作 Maka。',
    floating: '工作台已在浮窗中打开',
    restore: '收回工作台',
    stopAction: '停止', resumeAction: '恢复', actionPending: '已请求', actionFailed: '失败', stopDelivered: '停止指令已送达', alreadyTerminal: '已经结束', pendingCancelled: '已取消待执行工作', alreadyRunning: '已在运行', resumeStarted: '已启动恢复',
    delegationAccepted: '已接收', delegationRunning: '进行中', delegationWaiting: '等待用户',
  ...
  'zh-TW': { filterConversation: '篩選此 Work 的對話', clearConversationFilter: '顯示全部對話', noWorkConversation: '這段歷史中沒有此 Work 的對話。', work: '工作', attachmentLimit: '附件數量或大小超過限制', attachmentUploadFailed: '附件上傳失敗', reviewAttachments: '請查看附件。', sendFailed: '傳送失敗',
    ...
    progressTitle: 'WorkHub 進度', progressHint: '你可以繼續在 Maka 中操作。', progressClose: '本輪不再顯示進度',
    title: '工作台', turnFailed: '本輪執行失敗，詳情如下。',
    progressInput: '補充一句…',
    float: '浮出工作台',
    dock: '收回 Maka',
    hide: '隱藏',
    ...
    retry: '重試', selectModelToSend: '請先選擇模型', configureModelToSend: '請先設定可用模型', loadingModels: '正在載入模型…', noModelsAvailable: '暫無可用模型',
    reloadRequired: '工作台需要重新載入',
    welcome: '有什麼可以幫你？',
    hint: '問個問題、管理任務，或讓我幫你操作 Maka。',
    floating: '工作台已在浮動視窗中開啟',
    restore: '收回工作台',
    stopAction: '停止', resumeAction: '恢復', actionPending: '已請求', actionFailed: '失敗', stopDelivered: '停止指令已送達', alreadyTerminal: '已經結束', pendingCancelled: '已取消待執行工作', alreadyRunning: '已在執行', resumeStarted: '已啟動恢復',
    delegationAccepted: '已接收', delegationRunning: '進行中', delegationWaiting: '等待使用者',
