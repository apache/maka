...
const formattedCopy = {
  ...
  'zh-TW': {
    counts: [
      ['0 則生效', '草稿 0 則生效', '0 則已封存', '草稿 0 則已封存', '0 則記憶'],
      ['1 則生效', '草稿 1 則生效', '1 則已封存', '草稿 1 則已封存', '1 則記憶'],
      ['2 則生效', '草稿 2 則生效', '2 則已封存', '草稿 2 則已封存', '2 則記憶'],
    ],
    summaries: [
      ['目前 0 則生效；已保留上一版備份。', '0 則生效'],
      ['目前 1 則生效；已保留上一版備份。', '1 則生效'],
      ['目前 2 則生效；已保留上一版備份。', '2 則生效'],
      ['目前 0 則生效 / 2 則已封存；已保留上一版備份。', '0 則生效 / 2 則已封存'],
      ['目前 1 則生效 / 1 則已封存；已保留上一版備份。', '1 則生效 / 1 則已封存'],
      ['目前 1 則生效 / 2 則已封存；已保留上一版備份。', '1 則生效 / 2 則已封存'],
      ['目前 2 則生效 / 1 則已封存；已保留上一版備份。', '2 則生效 / 1 則已封存'],
      ['目前 2 則生效 / 2 則已封存；已保留上一版備份。', '2 則生效 / 2 則已封存'],
    ],
    redacted: [
      '寫入前已遮蔽疑似 token、API key 或密碼；目前 1 則生效；已保留上一版備份。',
      '寫入前已遮蔽疑似 token、API key 或密碼；目前 1 則生效 / 2 則已封存；已保留上一版備份。',
    ],
    ...
    labels: [
      ...
      '封存：Memory #2', '開啟備份候選 Backup #2', '還原備份候選 Backup #2',
      '複製備份候選引用 Backup #2', '封存到草稿，儲存前不會寫入 MEMORY.md',
