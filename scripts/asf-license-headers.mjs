...
export const exclusionRules = [
  ...
  },
  {
    ...
    matches: isOneOf(
      ...
      'apps/desktop/resources/licenses/cua-driver/upstream/simd-LICENSE',
      'apps/desktop/resources/licenses/cua-driver/upstream/jsonschema-LICENSE',
      'docs/computer-use-cua-driver-dependencies.tsv',
