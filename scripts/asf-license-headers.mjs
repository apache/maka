  ...
  },
  {
    ...
    matches: (path) =>
      isOneOf(
        ...
        // MIT collector from hqhq1025/open-codex-computer-history v0.2.0.
        'apps/desktop/native/computer-history/Package.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/AXTreeRevision.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/HistoryMaintenance.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/Models.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/Policy.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/RuntimeControl.swift',
        'apps/desktop/native/computer-history/Sources/HistoryCore/Store.swift',
        'apps/desktop/native/computer-history/Sources/OpenHistory/AXTreeCapture.swift',
        'apps/desktop/native/computer-history/Sources/OpenHistory/AccessibilitySnapshot.swift',
        'apps/desktop/native/computer-history/Sources/OpenHistory/HistoryRecorder.swift',
        'apps/desktop/native/computer-history/Sources/OpenHistory/main.swift',
        'apps/desktop/native/computer-history/Tests/HistoryCoreTests/AXTreeRevisionTests.swift',
        'apps/desktop/native/computer-history/Tests/HistoryCoreTests/EventSchemaTests.swift',
        'apps/desktop/native/computer-history/Tests/HistoryCoreTests/HistoryMaintenanceTests.swift',
        'apps/desktop/native/computer-history/Tests/HistoryCoreTests/PolicyTests.swift',
        'apps/desktop/native/computer-history/Tests/HistoryCoreTests/SegmentStoreTests.swift',
      )(path) ||
